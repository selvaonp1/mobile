    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int i =sq.insertProducts(spp, s2, s3, s4, s5,s6,s7);
                if(i == -1)
                {
                    Toast.makeText(AddProduct.this, "not registered", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(AddProduct.this, "successfully registered", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(AddProduct.this,AddItems.class);
                    startActivity(in);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(AddProduct.this,AddItems.class);
