...
public class UpdateEmBizz extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_em_bizz);
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sq.deleteEmBizz(s1))
                {
                    Toast.makeText(UpdateEmBizz.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(UpdateEmBizz.this,UpdateItems.class);
                    startActivity(in);
                }else{
                    Toast.makeText(UpdateEmBizz.this, "Delete failed", Toast.LENGTH_SHORT).show();
                }
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int i =sq.updateEmBizz(ss1, ss2, ss3, ss4, ss5, ss6, s1);
                if(i == -1)
                {
                    Toast.makeText(UpdateEmBizz.this, "not Updated", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(UpdateEmBizz.this, "successfully Updated", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(UpdateEmBizz.this,UpdateItems.class);
                    startActivity(in);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(UpdateEmBizz.this,UpdateItems.class);
