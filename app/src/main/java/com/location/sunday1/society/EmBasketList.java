...
public class EmBasketList extends AppCompatActivity implements  AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.em_basket_list);
        ...
        cursor = sq.queryNamepays12("food");
        String[] from = {"_id", "id", "category","product","subproduct","unit","unitname","price"};
        ...
        SimpleCursorAdapter cursorAdapter = new SimpleCursorAdapter(EmBasketList.this, R.layout.list3, cursor, from, to);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newActivity = new Intent(EmBasketList.this, UpdateEmBasket.class);
