    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1  .setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent In = new Intent(UpdateItems.this, EmBuddyList.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent In = new Intent(UpdateItems.this, EmBasketList.class);
                startActivity(In);
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent In = new Intent(UpdateItems.this, EmBassadorList.class);
                startActivity(In);
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent In = new Intent(UpdateItems.this, EmBizzList.class);
                startActivity(In);
            }
        });
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent In = new Intent(UpdateItems.this,EmBeventsList.class);
                startActivity(In);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(UpdateItems.this,AdminHomePage.class);
