...
public class AddEmbizz extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_embizz);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int i =sq.insertQueries(spp, s2, s3, s4, s5,s6);
                if(i == -1)
                {
                    Toast.makeText(AddEmbizz.this, "not registered", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(AddEmbizz.this, "successfully registered", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(AddEmbizz.this,AddItems.class);
                    startActivity(in);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(AddEmbizz.this,AddItems.class);
