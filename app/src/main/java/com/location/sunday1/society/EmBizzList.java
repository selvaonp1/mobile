...
public class EmBizzList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.em_bizz_list);
        ...
        SimpleCursorAdapter cursorAdapter = new SimpleCursorAdapter(EmBizzList.this, R.layout.list3, cursor, from, to);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newActivity = new Intent(EmBizzList.this, UpdateEmBizz.class);
