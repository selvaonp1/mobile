...
public class UpdateEmBassador extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_em_bassador);
        ...
        e7 = (EditText)findViewById(R.id.editText33);
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sq.deleteEmBassador(s1))
                {
                    Toast.makeText(UpdateEmBassador.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(UpdateEmBassador.this,UpdateItems.class);
                    startActivity(in);
                }else{
                    Toast.makeText(UpdateEmBassador.this, "Delete failed", Toast.LENGTH_SHORT).show();
                }
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ss7=e7.getText().toString();

                int i =sq.updateEmBassador(ss1, ss2, ss3, ss4, ss5, ss6,ss7, s1);
                if(i == -1)
                {
                    Toast.makeText(UpdateEmBassador.this, "not Updated", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(UpdateEmBassador.this, "successfully Updated", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(UpdateEmBassador.this,UpdateItems.class);
                    startActivity(in);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(UpdateEmBassador.this,UpdateItems.class);
