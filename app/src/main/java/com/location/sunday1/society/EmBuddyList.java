...
public class EmBuddyList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.em_buddy_list);
        ...
        cursor = sq.queryNamepays11("Electronic Fixes");
        String[] from = {"_id", "id", "category","service","service_provider_name","mobileno","landline","address"};
        int[] to = {R.id.textView110, R.id.textView111, R.id.textView112,R.id.textView113,R.id.textView114,R.id.textView115,R.id.textView116,R.id.textView117};
        SimpleCursorAdapter cursorAdapter = new SimpleCursorAdapter(EmBuddyList.this, R.layout.list3, cursor, from, to);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newActivity = new Intent(EmBuddyList.this, UpdateEmBuddy.class);
