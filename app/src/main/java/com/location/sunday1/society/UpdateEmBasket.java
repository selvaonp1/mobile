...
public class UpdateEmBasket extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_em_basket);
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sq.deleteEmBasket(s1))
                {
                    Toast.makeText(UpdateEmBasket.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(UpdateEmBasket.this,UpdateItems.class);
                    startActivity(in);
                }else{
                    Toast.makeText(UpdateEmBasket.this, "Delete failed", Toast.LENGTH_SHORT).show();
                }
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int i =sq.updateEmBasket(ss1, ss2, ss3, ss4, ss5, ss6, s1);
                if(i == -1)
                {
                    Toast.makeText(UpdateEmBasket.this, "not Updated", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(UpdateEmBasket.this, "successfully Updated", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(UpdateEmBasket.this,UpdateItems.class);
                    startActivity(in);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(UpdateEmBasket.this,UpdateItems.class);
